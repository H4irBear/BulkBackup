...
# Old Stuff when testing
#######################    
# hosts=open("hosts.list")
# 
# commands = ["show ver","show int status"]
# config = ["int gi1/0/1","int gi1/0/2"]
# device["username"] = input("User: ")
# device["password"] = passwd = getpass.getpass()
# 
# 
# for host in hosts:
#     device['host']=host.strip("\n")
# 
#     # auto enters config mode    
#     with ConnectHandler(**device) as ssh:
